...
Event.playerEatsPlayer = function (eater, eaten) {
...
Event.playerEatsFood = function (player) {
    let event = this.create({
...
Event.playerRespawns = function (player) {
    let event = this.create({
        volume: player.volume,
        playersEaten: player.playersEaten,
        foodEaten: player.foodEaten
...
Event.joinWorld = function (player) {
    let event = this.create({
        volume: player.volume,
        playersEaten: player.playersEaten,
        foodEaten: player.foodEaten
...
Event.leaveWorld = function (player) {
    let event = this.create({
        volume: player.volume,
        playersEaten: player.playersEaten,
        foodEaten: player.foodEaten
