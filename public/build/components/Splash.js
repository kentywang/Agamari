...
import { startGame, stopGame, setNickname, startAsGuest } from '../reducers/gameState.js';
class Splash extends Component {
    render() {
        let { updateNickname, gameState, play, playEnter, controlPanel, openBugReport } = this.props;
       ...
       {!bugReportOpen &&
                ...
                <div className="card-content white-text">
                    <button className="btn-floating" onClick={openBugReport}>
       ...
       <div id="title">AGAMARI</div>
        <div className="input-field">
          <input value={nickname} onChange={updateNickname} onKeyPress={playEnter} maxLength={15} type="text" id="name-box" placeholder="nickname" autoFocus/>
          <button className="Buttons" type="submit" style={nickname.trim() ? { color: 'white' } : { color: 'grey' }} onClick={play} id="play-box">play</button>
        </div>
        <div id="github">
